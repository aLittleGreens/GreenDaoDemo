...
public class ThreadTask
{
     ...
     * 网络线程最大数量
     */
    private final int netThreadCount = 6;
     ...
     * 其他类型的耗时线程数量
     */
    private final int otherThreadCount = 5;
    ...
    private ThreadTask()
    {
        ...
        dbThreadPool = new ThreadPoolExecutor(dbThreadCount, dbThreadCount, 0L,
                TimeUnit.MILLISECONDS, dbThreadQueue);// FixedThreadPool  核心线程和最大线程是相等的
        netThreadPool = new ThreadPoolExecutor(netThreadCount, netThreadCount,
                0L, TimeUnit.MILLISECONDS, netThreadQueue);// FixedThreadPool  核心线程和最大线程是相等的
